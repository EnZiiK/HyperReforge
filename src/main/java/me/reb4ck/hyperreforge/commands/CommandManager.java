...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public final List<me.reb4ck.hyperreforge.commands.Command> commands = new ArrayList<>();
    ...
    public void registerCommand(me.reb4ck.hyperreforge.commands.Command command) {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command cmd, @NotNull String label, String[] args) {
        ...
        for (me.reb4ck.hyperreforge.commands.Command command : commands) {
